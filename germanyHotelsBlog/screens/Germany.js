...
import { View, Text, ImageBackground, TouchableOpacity, ScrollView, Modal, TextInput, KeyboardAvoidingView } from "react-native";
import { uid } from 'uid';
...
const Germany = ({ navigation }) => {
    ...
    const setData = async () => {
        try {
            ...
            await AsyncStorage.setItem("Germany", jsonData);
    ...
    const getData = async () => {
        try {
            const jsonData = await AsyncStorage.getItem('Germany');
            if (jsonData !== null) {
            ...
            >
                <View style={{ flex: 1, position: 'relative' }}>
                    ...
                    <View>
                        ...
                        <TouchableOpacity
                            activeOpacity={1}
                            style={{ width: '70%', height: 50, borderTopRightRadius: 10, borderBottomRightRadius: 10, alignItems: 'center', justifyContent: 'center', backgroundColor: 'gold', marginTop: 30, marginBottom: 10 }}//rgba(196,0,0,1)
                        >
                            ...
                            <View >
                                <ScrollView style={{ marginBottom: 170 }}>
                                    ...
                                    {hotels.map((hotel) => {
                                        return (
                                            <TouchableOpacity
                                                onPress={() => { navigation.navigate('Hotel', hotel) }}
